// app/lib/sanitizeUserProfile.ts
 ...
 * 3. Pads missing arrays or fields in a QuizAttempt to ensure it meets a minimum structure.
 */
...
export function sanitizeQuizAttempt(raw: any): Partial<QuizAttempt> | null {
  ...
  // ✅ totalQuestions is now always a number
  ...
  // ✅ countUnanswered receives a non-undefined array
