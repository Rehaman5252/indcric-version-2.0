              ...
              <Accordion type="single" collapsible className="w-full space-y-2">
                ...
                <AccordionItem value="legal-19" className="bg-card border rounded-lg px-4">
                  ...
                  <AccordionContent className="prose dark:prose-invert max-w-none">
                    ...
                    <strong>Address:</strong> 15-1-47/2, Panasathota, Narasaraopet, Paanadu, Guntur, Andhra Pradesh – 522601</p>
                ...
                <AccordionItem value="legal-21" className="bg-card border rounded-lg px-4">
                  ...
                  <AccordionContent className="prose dark:prose-invert max-w-none">
                    <h4>21.1 Version:</h4>
                    <p>This is Version 1.0 of the IndCric Strict-Legal Policy Suite.</p>
