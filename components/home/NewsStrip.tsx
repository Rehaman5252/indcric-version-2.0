...
export default function NewsStrip() {
  ...
  <Newspaper className="h-5 w-5 text-yellow-50" />
</div>
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col justify-between p-4 z-10">
                ...
                <div className="space-y-2 w-full">
                  ...
                  {/* MOBILE: Only Read More Button - Always visible, no description to save space */}
                  <div className="block sm:hidden">
                    <button
                      onClick={(e) => handleReadMore(e, newsItem)}
                      className="inline-flex items-center gap-1 px-3 py-1.5 bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-black text-xs font-bold rounded-lg transition-all hover:shadow-lg hover:shadow-yellow-500/50 active:scale-95 w-full justify-center"
                    >
                  ...
                  {/* DESKTOP: Description + Button - Only on hover on desktop */}
                  <div className="hidden sm:block opacity-0 group-hover:opacity-100 transition-opacity duration-500 space-y-2">
                    {/* Description */}
      ...
      <AnimatePresence>
        {selectedNewsForModal && (
          <>
            ...
            >
              <div
                className="bg-gradient-to-br from-gray-900 to-black rounded-2xl border-2 border-yellow-500/40 shadow-2xl shadow-yellow-500/20 max-w-2xl max-h-[85vh] overflow-y-auto w-full"
