...
export default function QuizClient({ brand, format }: QuizClientProps) {
  ...
  // ✅ FUNCTION 1: handleAdFinished (MUST be BEFORE handleHintRequest)
  ...
  // ✅ FUNCTION 2: handleHintRequest (NOW SAFE - handleAdFinished is declared above)
  ...
  return (
    <AdDialog
      ...
      hideSkipButton={true} // ⬅️ added: no skip button for quiz interstitial video ads
    />
  );
}


    // Fallback for static type without logo
    return (
      <AdDialog
        open={true}
        onOpenChange={() => {}}
